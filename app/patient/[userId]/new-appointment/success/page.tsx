...
async function Success({ params, searchParams }: SearchParamProps) {
  ...
  const appointmentIdd = (SearchParams?.appointmentId as string) || "";
  const appointment = await getAppointment(appointmentIdd);
      ...
      <div className="success-img ">
        ...
        <section className="flex flex-col items-center">
          <Image
            ...
            alt="success"
          />
          <h2 className="header mb-6 max-[600px] text-center">
